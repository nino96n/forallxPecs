...
\problempart
\label{pr.QLcandies}
Az adott szimbolizációs kulcsot felhasználva fordítsunk le minden egyes (angol-nyelvű) mondatot Predikátumlogikára.
\begin{ekey}
\item[UD:] cukorkák
...
\item Mindenki szereti a guacamolet.
\item Ha mindenki szereti a guacamolet, akkor Eli is.
...
\item Eli kedvel bárkit, aki szereti a guacamolet.
